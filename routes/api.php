...
Route::group([
    ...
    Route::get('/profile/form/{schema_id}', [ProfileController::class, 'form'])->name('api.profile.create');
    Route::post('/profile/create', [ProfileController::class, 'create'])->name('api.profile.create');
    Route::get('/profile/edit/{id}', [ProfileController::class, 'edit'])->name('api.profile.edit');
    ...
    Route::get('/profile/{id}/processes', [ProfileController::class, 'getProfileProcesses'])->name('api.profile.processes');
    ...
    Route::post('/process/update-process-status', [ProcessController::class, 'updateProcessStatus'])->name('api.process.update-process-status');
